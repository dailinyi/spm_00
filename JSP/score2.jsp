        ...
        <div class="mainbar">
     	...
     	<tbody>
     	  <tr>
     	    ...
     	    <div class="pagenavi">
<span class="pages"><font size="1"><strong>Page 2 of 3</strong></font></span>
<a style="border-radius: 5px 5px 5px 5px;" href="score.jsp"><strong>‹‹</strong></a>
<a style="border-radius: 5px 5px 5px 5px;" href="score.jsp" title="1"><strong>一班</strong></a>
<span style="border-radius: 5px 5px 5px 5px;" class="current"><strong>二班</strong></span>
<a style="border-radius: 5px 5px 5px 5px;" href="score3.jsp" title="3"><strong>三班</strong></a>
<a style="border-radius: 5px 5px 5px 5px;" href="score3.jsp"><strong>››</strong></a>
</div>
			 ...
			 <td>总成绩</td>
		      ...
		      //out.println(apath);
		      FileReader fr=new FileReader(apath + "\\Excel\\2.txt");
