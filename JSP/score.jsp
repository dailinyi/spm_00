        ...
        <div class="mainbar">
     	...
     	<tbody>
     	  <tr>
     	    ...
     	    <div class="pagenavi">
<span class="pages"><font size="1"><strong>Page 1 of 3</strong></font></span>
<a style="border-radius: 5px 5px 5px 5px;" ><strong>‹‹</strong></a>
<span style="border-radius: 5px 5px 5px 5px;" class="current"><strong>一班</strong></span>
...
<a style="border-radius: 5px 5px 5px 5px;" href="score2.jsp"><strong>››</strong></a>
			 ...
			 <td>总成绩</td>
		      ...
		      //out.println(apath);
		      FileReader fr=new FileReader(apath + "\\Excel\\1.txt");
