...
<script>
	$(document).ready(function(){	
    		...
    		$(".main .main_resize .sidebar .gadget .sb_menu li#stushow").addClass("active");
    ...
    <div class="content">
      <div class="content_bg">
        <div class="mainbar">
          <div class="article">
            <div class="clr"></div>
            <font size="5"><center><strong>学生实践过程展示</strong></center></font><br/>
...
<!--Start Tabcontent 2-->
<div id="tabcontent2"><p><img src="<%=request.getContextPath()%>/pic/work2.jpg" width="680" height="500"/></p></div>
<!--End Tabcontent 2 -->

<!--Start Tabcontent 3-->
<div id="tabcontent3"><p><img src="<%=request.getContextPath()%>/pic/work3.png" width="680" height="500"/></p></div>
<!--End Tabcontent 3-->

<!--Start Tabcontent 4-->
<div id="tabcontent4"><p><img src="<%=request.getContextPath()%>/pic/work4.jpg" width="680" height="500"/></p></div>
<!--End Tabcontent 4-->
