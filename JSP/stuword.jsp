...
<script>
	$(document).ready(function(){	
    		...
    		$(".main .main_resize .sidebar .gadget .sb_menu li#stuword").addClass("active");
    ...
    <div class="content">
      <div class="content_bg">
        <div class="mainbar">
          <div class="article">
            <div class="clr"></div>
            <font size="5"><center><strong>学生实践文档展示</strong></center></font><br/>
...
<!--Start Tabcontent 1 -->
<div id="tabcontent1"><p><img src="<%=request.getContextPath()%>/pic/paper1.png" width="680" height="500"/></p></div>
<!--End Tabcontent 1-->

<!--Start Tabcontent 2-->
<div id="tabcontent2"><p><img src="<%=request.getContextPath()%>/pic/paper2.png" width="680" height="500"/></p></div>
<!--End Tabcontent 2 -->

<!--Start Tabcontent 3-->
<div id="tabcontent3"><p><img src="<%=request.getContextPath()%>/pic/paper3.png" width="680" height="500"/></p></div>
<!--End Tabcontent 3-->

<!--Start Tabcontent 4-->
<div id="tabcontent4"><p><img src="<%=request.getContextPath()%>/pic/paper4.png" width="680" height="500"/></p></div>
<!--End Tabcontent 4-->
